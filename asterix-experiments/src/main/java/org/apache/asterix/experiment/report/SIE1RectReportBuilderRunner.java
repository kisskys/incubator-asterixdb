...
public class SIE1RectReportBuilderRunner {
    String expHomePath = "/Users/kisskys/workspace/asterix_master/resultLog/Rect-MemBuf3g-DiskBuf3g-Lsev-Jvm7g-Lock0g/exp1-rect-house-test/";
    String runLogFileName = "run-exp1.log";
    String outputFilePath = "/Users/kisskys/workspace/asterix_master/resultLog/Rect-MemBuf3g-DiskBuf3g-Lsev-Jvm7g-Lock0g/result-report/";
    ...
    public void generateSIE1IPS() throws Exception {
        ...
        sb.append("# number of nodes, rtree, shbtree\n");
        sb.append("1,").append(sie1ARtree.getOverallInsertPS(minutes)).append(",")
                .append(sie1AShbtree.getOverallInsertPS(minutes)).append("\n");

        sb.append("2,").append(sie1BRtree.getOverallInsertPS(minutes)).append(",")
                .append(sie1BShbtree.getOverallInsertPS(minutes)).append("\n");

        sb.append("4,").append(sie1CRtree.getOverallInsertPS(minutes)).append(",")
                .append(sie1CShbtree.getOverallInsertPS(minutes)).append("\n");

        sb.append("8,").append(sie1DRtree.getOverallInsertPS(minutes)).append(",")
    ...
    public void generateIndexSize() throws Exception {
        ...
        sb.append("# number of nodes, rtree, shbtree, pidx\n");
        sb.append("1,").append(sie1ARtree.getIndexSize("Tweets_idx_rtreeLocation/device_id")).append(",")
        ...
        sb.append("2,").append(sie1BRtree.getIndexSize("Tweets_idx_rtreeLocation/device_id")).append(",")
        ...
        sb.append("4,").append(sie1CRtree.getIndexSize("Tweets_idx_rtreeLocation/device_id")).append(",")
        ...
        sb.append("8,").append(sie1DRtree.getIndexSize("Tweets_idx_rtreeLocation/device_id")).append(",")
