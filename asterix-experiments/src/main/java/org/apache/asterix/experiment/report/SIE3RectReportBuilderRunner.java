...
public class SIE3RectReportBuilderRunner {
    ...
    public SIE3RectReportBuilderRunner() {

        String expHomePath = "/Users/kisskys/workspace/asterix_master/resultLog/Tune-Shbtree-Rect-InstantLock-MemBuf1g-DiskBuf3g-Lsev-Jvm7g-Lock6p5g/lake/exp3-lake-tune-shbtree-40/";
        ...
        String runLogFileName = "run-exp3-lake-shbtree40.log";
        profileLogFileName = "run-exp4-lake.log";; //"profile-exp3.log";
    ...
    public void generateIndexSize() throws Exception {
        ...
        sb.append("# pidx,").append(sie3Shbtree.getIndexSize("Tweets_idx_Tweets/device_id")).append("\n");
    ...
    public void generateSelectQueryResponseTime() throws Exception {
        ...
        sb.append("0.00001,").append(sie3Rtree.getSelectQueryResponseTime(0)).append(",")
                .append(sie3Shbtree.getSelectQueryResponseTime(0)).append("\n");
        sb.append("0.0001,").append(sie3Rtree.getSelectQueryResponseTime(1)).append(",")
                .append(sie3Shbtree.getSelectQueryResponseTime(1)).append("\n");
        sb.append("0.001,").append(sie3Rtree.getSelectQueryResponseTime(2)).append(",")
                .append(sie3Shbtree.getSelectQueryResponseTime(2)).append("\n");
        sb.append("0.01,").append(sie3Rtree.getSelectQueryResponseTime(3)).append(",")
                .append(sie3Shbtree.getSelectQueryResponseTime(3)).append("\n");
        sb.append("0.1,").append(sie3Rtree.getSelectQueryResponseTime(4)).append(",")
                .append(sie3Shbtree.getSelectQueryResponseTime(4)).append("\n");

        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_select_query_response_time.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
    }
    ...
    public void generateSelectQueryResultCount() throws Exception {
        ...
        sb.append("radius, rtree, shbtree\n");
        sb.append("0.00001,").append(sie3Rtree.getSelectQueryResultCount(0)).append(",")
                .append(sie3Shbtree.getSelectQueryResultCount(0)).append("\n");
        sb.append("0.0001,").append(sie3Rtree.getSelectQueryResultCount(1)).append(",")
                .append(sie3Shbtree.getSelectQueryResultCount(1)).append("\n");
        sb.append("0.001,").append(sie3Rtree.getSelectQueryResultCount(2)).append(",")
                .append(sie3Shbtree.getSelectQueryResultCount(2)).append("\n");
        sb.append("0.01,").append(sie3Rtree.getSelectQueryResultCount(3)).append(",")
                .append(sie3Shbtree.getSelectQueryResultCount(3)).append("\n");
        sb.append("0.1,").append(sie3Rtree.getSelectQueryResultCount(4)).append(",")
    ...
    public void generateJoinQueryResponseTime() throws Exception {
        ...
        sb.append("radius, rtree, shbtree\n");
        sb.append("0.00001,").append(sie3Rtree.getJoinQueryResponseTime(0)).append(",")
                .append(sie3Shbtree.getJoinQueryResponseTime(0)).append("\n");
        sb.append("0.0001,").append(sie3Rtree.getJoinQueryResponseTime(1)).append(",")
                .append(sie3Shbtree.getJoinQueryResponseTime(1)).append("\n");
        sb.append("0.001,").append(sie3Rtree.getJoinQueryResponseTime(2)).append(",")
                .append(sie3Shbtree.getJoinQueryResponseTime(2)).append("\n");
        sb.append("0.01,").append(sie3Rtree.getJoinQueryResponseTime(3)).append(",")
    ...
    public void generateJoinQueryResultCount() throws Exception {
        ...
        sb.append("radius, rtree, shbtree\n");
        sb.append("0.00001,").append(sie3Rtree.getJoinQueryResultCount(0)).append(",")
                .append(sie3Shbtree.getJoinQueryResultCount(0)).append("\n");
        sb.append("0.0001,").append(sie3Rtree.getJoinQueryResultCount(1)).append(",")
                .append(sie3Shbtree.getJoinQueryResultCount(1)).append("\n");
        sb.append("0.001,").append(sie3Rtree.getJoinQueryResultCount(2)).append(",")
                .append(sie3Shbtree.getJoinQueryResultCount(2)).append("\n");
        sb.append("0.01,").append(sie3Rtree.getJoinQueryResultCount(3)).append(",")
                .append(sie3Shbtree.getJoinQueryResultCount(3)).append("\n");
    ...
    public void generateSelectQueryProfiledSidxSearchTime() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_select_query_profiled_sidx_search_time.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
    }
    ...
    public void generateSelectQueryProfiledPidxSearchTime() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_select_query_profiled_pidx_search_time.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
    }
    ...
    public void generateJoinQueryProfiledSidxSearchTime() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_join_query_profiled_sidx_search_time.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
    }
    ...
    public void generateJoinQueryProfiledPidxSearchTime() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_join_query_profiled_pidx_search_time.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
    }
    ...
    public void generateJoinQueryProfiledSeedPidxSearchTime() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_join_query_profiled_seed_pidx_search_time.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
    }
    ...
    public void generateSelectQueryProfiledSidxCacheMiss() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_select_query_profiled_sidx_cache_miss.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
    }
    ...
    public void generateSelectQueryProfiledPidxCacheMiss() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_select_query_profiled_pidx_cache_miss.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
    }
    ...
    public void generateJoinQueryProfiledSidxCacheMiss() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_join_query_profiled_sidx_cache_miss.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
    }
    ...
    public void generateJoinQueryProfiledPidxCacheMiss() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_join_query_profiled_pidx_cache_miss.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
    }
    ...
    public void generateJoinQueryProfiledSeedPidxCacheMiss() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_join_query_profiled_seed_pidx_cache_miss.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
    }
    ...
    public void generateSelectQueryProfiledFalsePositive() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_select_query_profiled_false_positive_raw.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
        generateFalsePositive(outputFilePath + "sie3_select_query_profiled_false_positive_raw.txt",
                outputFilePath + "sie3_select_query_result_count.txt",
                outputFilePath + "sie3_select_query_profiled_false_positive.txt", false);
    }
    ...
    public void generateJoinQueryProfiledFalsePositive() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_join_query_profiled_false_positive_raw.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);

        generateFalsePositive(outputFilePath + "sie3_join_query_profiled_false_positive_raw.txt",
                outputFilePath + "sie3_join_query_result_count.txt",
                outputFilePath + "sie3_join_query_profiled_false_positive.txt", true);
    }
    ...
    public void generateQueryProfiledOperatorTime() throws Exception {
        ...
        executionTimeFileParentPath[0] = parentPath + "SpatialIndexExperiment3Rtree/logs/";
        executionTimeFileParentPath[1] = parentPath + "SpatialIndexExperiment3Shbtree/logs/";
        ...
        for (int i = 0; i < 5; i++) {
            ...
            String[] st = null;
            sb.append(
                    "operator, STREAM_SELECT, SORT_RUN_GEN, PIDX_SEARCH, STREAM_PROJECT, SPLIT, SIDX_SEARCH, ASSIGN, UNION_ALL, SORT_RUN_MERGER, TXN_JOB_COMMIT, DISTRIBUTE_RESULT,\n");
            ...
            FileOutputStream fos = ReportBuilderHelper
                    .openOutputFile(outputFilePath + "sie3_select_query_operator_profile_time_r" + i + ".txt");
            fos.write(sb.toString().getBytes());
            ReportBuilderHelper.closeOutputFile(fos);
        }
        ...
        for (int i = 0; i < 4; i++) {
            ...
            String[] st = null;
            sb.append(
                    "operator, STREAM_SELECT,SORT_RUN_GEN, INNER_PIDX_SEARCH,OUTER_PIDX_SEARCH,SPLIT,STREAM_PROJECT,INNER_SIDX_SEARCH,UNION_ALL,ASSIGN,SORT_RUN_MERGER,TXN_JOB_COMMIT,DISTRIBUTE_RESULT,\n");
            ...
            FileOutputStream fos = ReportBuilderHelper
                    .openOutputFile(outputFilePath + "sie3_join_query_operator_profile_time_r" + i + ".txt");
            fos.write(sb.toString().getBytes());
            ReportBuilderHelper.closeOutputFile(fos);
        }
    }
    ...
    public void generateQueryProfiledCacheMiss() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            FileOutputStream fos = ReportBuilderHelper
                    .openOutputFile(outputFilePath + "sie3_select_query_cache_miss_r" + i + ".txt");
            fos.write(sb.toString().getBytes());
            ReportBuilderHelper.closeOutputFile(fos);
        }
        ...
        for (int i = 0; i < 4; i++) {
            ...
            FileOutputStream fos = ReportBuilderHelper
                    .openOutputFile(outputFilePath + "sie3_join_query_cache_miss_r" + i + ".txt");
            fos.write(sb.toString().getBytes());
            ReportBuilderHelper.closeOutputFile(fos);
        }
    }
    ...
    public void generateQueryProfiledFalsePositive() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_select_query_false_positive.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
    ...
    public void generateIndexBuildProfiledCacheMiss() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_index_creation_cache_miss_time.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
    ...
    public void generateIndexBuildProfiledOperatorTime() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper
                .openOutputFile(outputFilePath + "sie3_index_build_operator_profile_time.txt");
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
    }
