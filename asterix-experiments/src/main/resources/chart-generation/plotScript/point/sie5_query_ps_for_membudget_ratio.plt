...
set output "sie5_query_ps_for_membudget_ratio.eps"
...
plot "sie5_query_ps_for_membudget.txt" using ($2/$4*100):xtic(1) ti col(2), '' u ($3/$4*100) ti col(3), '' u ($4/$4*100) ti col(4), '' u ($5/$4*100) ti col, '' u ($6/$4*100) ti col 
