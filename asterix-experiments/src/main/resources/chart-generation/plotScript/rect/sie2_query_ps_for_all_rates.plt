...
set output "sie2_query_ps_for_all_rates.eps"
...
#plot "sie2_query_ps_for_all_rates.txt" using 2:xtic(1) ti col, '' u 3 ti col, '' u 4 ti col, '' u 5 ti col, '' u 6 ti col 
plot "sie2_query_ps_for_all_rates.txt" using 2:xtic(1) ti col fillstyle pattern 2, '' u 3 ti col fillstyle pattern 3
