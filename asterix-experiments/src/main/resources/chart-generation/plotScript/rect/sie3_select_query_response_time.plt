...
set output "sie3_select_query_response_time.eps"
...
plot "sie3_select_query_response_time.txt" using 2:xtic(1) ti col fillstyle pattern 2, '' u 3 ti col fillstyle pattern 3
