...
plot "sie4_select_query_cache_miss_r0.txt" using 3:xtic(1) ti col ls 1 fs pattern 3, '' u 2 ti col ls 2 fs pattern 3
...
plot "sie4_select_query_cache_miss_r1.txt" using 3:xtic(1) ti col ls 1 fs pattern 3, '' u 2 ti col ls 2 fs pattern 3
...
plot "sie4_select_query_cache_miss_r2.txt" using 3:xtic(1) ti col ls 1 fs pattern 3, '' u 2 ti col ls 2 fs pattern 3
...
plot "sie4_select_query_cache_miss_r3.txt" using 3:xtic(1) ti col ls 1 fs pattern 3, '' u 2 ti col ls 2 fs pattern 3
...
plot "sie4_select_query_cache_miss_r4.txt" using 3:xtic(1) ti col ls 1 fs pattern 3, '' u 2 ti col ls 2 fs pattern 3
...
plot "sie4_join_query_cache_miss_r0.txt" using 4:xtic(1) ti col ls 1 fs pattern 3, '' u 2 ti col ls 2 fs pattern 3, '' u 3 ti col ls 1 fs pattern 0 
...
plot "sie4_join_query_cache_miss_r1.txt" using 4:xtic(1) ti col ls 1 fs pattern 3, '' u 2 ti col ls 2 fs pattern 3, '' u 3 ti col ls 1 fs pattern 0  
...
plot "sie4_join_query_cache_miss_r2.txt" using 4:xtic(1) ti col ls 1 fs pattern 3, '' u 2 ti col ls 2 fs pattern 3, '' u 3 ti col ls 1 fs pattern 0  
...
plot "sie4_join_query_cache_miss_r3.txt" using 4:xtic(1) ti col ls 1 fs pattern 3, '' u 2 ti col ls 2 fs pattern 3, '' u 3 ti col ls 1 fs pattern 0  