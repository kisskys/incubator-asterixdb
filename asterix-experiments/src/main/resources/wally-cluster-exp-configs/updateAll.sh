...
tar -zxvf /data/seok.kim/spatial-index-experiment/files/ingestion-experiment-binary-and-configs.tar.gz -C /data/seok.kim/spatial-index-experiment/
...
unzip /data/seok.kim/spatial-index-experiment/files/asterix-installer-0.8.7-SNAPSHOT-binary-assembly.zip -d /data/seok.kim/spatial-index-experiment/asterix-instance/;
